    ...
    <div className=" flex justify-center">
      <div className="lg:w-11/12 w-full flex  justify-center lg:p-16 p-0 border lg:h-screen">
        <div className=" border  lg:w-2/5 w-full lg:h-[20.25rem] flex flex-col gap-10 p-10">
          <div>
            <h2 className="lg:text-3xl  text-sm">
              To Start the Quiz Enter User Name
            </h2>
          </div>
          <label htmlFor="name">
            User Name
            <input
              className="border border-lime-400 p-2 w-full"
              type="text"
              value={userName}
          ...
          <Link to={"/difficulty"}>
            <div
              className="bg-lime-400	 hover:bg-lime-700	 text-white w-full  font-bold py-2 px-4 rounded"
